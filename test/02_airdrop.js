...
const Token = artifacts.require('AToken.sol');
...
contract('Airdrop', ([admin, _]) => {
  ...
  beforeEach(async () => {
    ...
    airdrop = await Airdrop.new(token.address, AIRDROP);
  ...
  const createSignature = params => {
    ...
    const privKey = '0x481e163897bffa8c90fba263b35f1b9fe327fb5d2effc914a0d1756e56b3cf93';
